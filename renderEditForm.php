...
function renderEditForm($full_name, $email, $location, $num_watched, $fav_movie, $error) {
?>
<!doctype html>
		...
		<div>
			...
			<div>
				...
				<input type="radio" name="fav_movie" id="fav_movie" <?php echo ($fav_movie=="Harry Potter and the Deathly Hallows – Part 1"
				 )? 'checked': ''?> value="Harry Potter and the Deathly Hallows – Part 1">Harry Potter and the Deathly Hallows – Part 1
				<br>
				<input type="radio" name="fav_movie" id="fav_movie" <?php echo ($fav_movie=="Harry Potter and the Deathly Hallows – Part 2"
				 )? 'checked': ''?> value="Harry Potter and the Deathly Hallows – Part 2">Harry Potter and the Deathly Hallows – Part 2
				<br>
			</div>
